...
class ControleRemoto:
    ...
    def volume_menos(self):
        if self.ligado:
            if self.volume_atual != ControleRemoto.valume_min:
                self.volume_atual -= 1
    ...
    def mostrar_tv(self):
        ...
        if not self.ligado:
            ...
            conteudo += f"\nVolume = "
            # Interando sobre o volume
            for volume in range(ControleRemoto.valume_min, ControleRemoto.volume_max + 1):
